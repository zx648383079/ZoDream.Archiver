    ...
    public static class BitmapFactory
    {
        ...
        public static IBufferDecoder CreateDecoder(BitmapFormat format)
        {
            return format switch
            {
                ...
                BitmapFormat.ARGBFP32 => new FloatSwapDecoder(ColorSwapper.ARGB),
                BitmapFormat.RGBFP32 => new FloatSwapDecoder(ColorSwapper.RGB),
                BitmapFormat.RGBFP16 => new HalfSwapDecoder(ColorSwapper.RGB),
                ...
                BitmapFormat.ARGB8888 => new RGBASwapDecoder(ColorSwapper.ARGB),
