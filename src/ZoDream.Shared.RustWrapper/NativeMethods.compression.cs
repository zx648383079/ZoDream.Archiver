...
namespace ZoDream.Shared.RustWrapper
{
    internal unsafe static partial class NativeMethods
    {
        ...
        [DllImport(RustDllName, ExactSpelling = true)]
        public static unsafe extern int compress_compressor(CompressorRef* compressor, ref InputStreamRef input, ref OutputStreamRef output);

        [DllImport(RustDllName, ExactSpelling = true)]
        public static unsafe extern int decompress_compressor(CompressorRef* compressor, ref InputStreamRef input, ref OutputStreamRef output);
