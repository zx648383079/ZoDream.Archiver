...
{
    public class LuaJitReader : ILanguageReader
    {
            ...
            Queue<LuaChunk> protoItems)
        {
            ...
            chunk.UpValueItems = reader.ReadArray(chunk.UpValueCount, (_, _) => {
            ...
            if (debugInfoSize > 0)
            {
                ...
                chunk.SourceLineItems = reader.ReadArray(instructionsCount, (_, _) => {
                    return ((uint)chunk.LineDefined + lineCount switch
                    {
                ...
                chunk.UpValueNameItems = reader.ReadArray(chunk.UpValueCount, (_, _) => {
