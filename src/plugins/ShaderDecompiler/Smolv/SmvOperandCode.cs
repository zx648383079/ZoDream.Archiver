...
{
    public struct SmvOperandCode
    {
        public SmvOperandCode(byte hasResult, byte hasType, sbyte deltaFromResult, byte varRest)
        {
            HasResult = hasResult;
            HasType = hasType;
		...
		public static SmvOperandCode Get(SmvOperand op)
		{
			return CodeItems[(int)op];
		}

        public static readonly SmvOperandCode[] CodeItems = [
            new(0, 0, 0, 0), // Nop
			new(1, 1, 0, 0), // Undef
