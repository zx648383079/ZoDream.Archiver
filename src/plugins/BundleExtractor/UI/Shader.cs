...
namespace ZoDream.BundleExtractor.UI
{
    ...
    public class ConstantBuffer
    {
        ...
        public ConstantBuffer(UIReader reader)
        {
            ...
            if (version.GreaterThanOrEquals(2020,3,2, Models.UnityVersionType.Final, 1) || //2020.3.2f1 and up
              version.GreaterThanOrEquals(2021, 1, 4, Models.UnityVersionType.Final, 1)) //2021.1.4f1 and up
            {
    ...
    public class SerializedProgram
    {
        ...
        public SerializedProgram(UIReader reader)
        {
            ...
            if (version.GreaterThanOrEquals(2021,3,10, Models.UnityVersionType.Final, 1) || //2021.3.10f1 and up
               version.GreaterThanOrEquals(2022, 1, 13, Models.UnityVersionType.Final, 1)) //2022.1.13f1 and up
            {
            ...
            if (version.GreaterThanOrEquals(2020, 3, 2, Models.UnityVersionType.Final, 1) || //2020.3.2f1 and up
               version.GreaterThanOrEquals(2021, 1, 1, Models.UnityVersionType.Final, 1)) //2021.1.1f1 and up
            {
    ...
    public class Shader : NamedObject, IFileWriter
    {
        ...
        public Shader(UIReader reader) : base(reader)
        {
            ...
            if (version.GreaterThanOrEquals(5,5)) //5.5 and up
            {
                ...
                if (version.GreaterThanOrEquals(2021,3,12, Models.UnityVersionType.Final,1) || //2021.3.12f1 and up
                    version.GreaterThanOrEquals(2022, 1, 21, Models.UnityVersionType.Final, 1)) //2022.1.21f1 and up
                {
