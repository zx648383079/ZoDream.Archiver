...
namespace Il2CppDumper
{
    public class DummyAssemblyGenerator
    {
        ...
        private readonly Dictionary<int, FieldDefinition> fieldDefinitionDic = [];
        private readonly Dictionary<int, PropertyDefinition> propertyDefinitionDic = [];
        private readonly Dictionary<int, MethodDefinition> methodDefinitionDic = [];
        ...
        private void CreateCustomAttribute(Il2CppImageDefinition imageDef, int customAttributeIndex, uint token, ModuleDefinition moduleDefinition, Collection<CustomAttribute> customAttributes)
        {
            ...
            if (attributeIndex >= 0)
            {
                ...
                {
                    Debug.WriteLine($"ERROR: Error while restoring attributeIndex {attributeIndex}");
                }
            }
        }
